...
<table class="report-header-table">
   <tr>
      ...
      <td align="center" style="text-align: center;">
         ...
         <h2 class="report-title">DAFTAR HADIR SISWA</h2>
...
<table class="meta-table">
   <tr>
      ...
      <td width="50%" align="right" style="text-align: right;"><strong>Kelas:</strong> <?= esc($kelas['kelas']); ?></td>
   </tr>
</table>
...
<table class="report-table <?= $rangeClass ?>">
   <thead>
      <tr>
         ...
         <th rowspan="3" class="student-name-header">Nama Siswa</th>
   ...
   <tbody>
      ...
      ?>
         <tr class="student-row">
            <td><?= $i + 1; ?></td>
            <td class="student-name-td"><?= esc($siswa['nama_siswa']); ?></td>
   ...
   <tr style="border: none;">
      <td width="50%" style="vertical-align: top; border: none; padding: 0;">
         <div class="summary-card">
            <h5><b>Detail Data Kelas</b></h5>
            <div class="summary-row">
               <span>Jumlah Siswa</span>
               <span class="summary-value">: <?= count($listSiswa); ?> orang</span>
            </div>
            <div class="summary-row">
               <span>Laki-laki</span>
               <span class="summary-value">: <?= $rekapSiswa['laki']; ?> orang</span>
            </div>
            <div class="summary-row">
               <span>Perempuan</span>
               <span class="summary-value">: <?= $rekapSiswa['perempuan']; ?> orang</span>
            </div>
         </div>
      </td>
      <td width="50%" style="vertical-align: top; border: none; padding: 0;" align="right">
         ...
         $totalPossibleDays = $countSiswa * $activeDays;
         ...
         <div class="summary-card" style="text-align: left;">
            <h5><b>Rata-rata Kehadiran Kelas (<?= $activeDays; ?> Hari Aktif)</b></h5>
            <div class="summary-row">
